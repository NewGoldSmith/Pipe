...
// PopeProbe.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CPopeProbeApp, CWinApp)
...
// 唯一の CPopeProbeApp オブジェクト

CPopeProbeApp theApp;


// CPopeProbeApp の初期化

BOOL CPopeProbeApp::InitInstance()
{
