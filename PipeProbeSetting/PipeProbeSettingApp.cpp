...
// PipeProbeSetting.cpp : アプリケーションのクラス動作を定義します。
//
...
BEGIN_MESSAGE_MAP(CPipeProbeSettingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CPipeProbeSettingApp の構築

CPipeProbeSettingApp::CPipeProbeSettingApp()
{
...
// 唯一の CPipeProbeSettingApp オブジェクト

CPipeProbeSettingApp theApp;


// CPipeProbeSettingApp の初期化

BOOL CPipeProbeSettingApp::InitInstance()
{
